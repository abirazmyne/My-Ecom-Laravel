...
@section('body')
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title"> Order Delete</h1>
        </div>
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('admin-order.all')}}">Order</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="{{route('admin.order-delete',['id'=> $order->id])}}">Order Delete</a></li>
            </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
                            ...
                            @foreach ($orders as $order)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('admin.order-edit', ['id' => $order->id])}}" class="btn btn-success" title="Edit Orders">
                                        ...
                                        <a href="{{route('admin.order-delete', ['id' => $order->id])}}" title=" Order Delete" onclick="return confirm('Are you sure you want to delete this category?')" class="btn btn-danger">
