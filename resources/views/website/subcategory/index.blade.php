            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="breadcrumbs-content">
                        <h1 class="page-title">Sub Category Menu</h1>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-12">
...
{{--                                        </select>--}}
                                        <h3 class="total-show-product">Showing: <span>{{ $subCategoryProducts->firstItem() }} - {{ $subCategoryProducts->lastItem() }} items</span></h3>
                                    </div>
                                </div>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-grid" role="tabpanel" aria-labelledby="nav-grid-tab">
                                <div class="row">
                                    @foreach($subCategoryProducts as $categoryProduct)
                            ...
                            <div class="tab-pane fade" id="nav-list" role="tabpanel" aria-labelledby="nav-list-tab">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        {{--                                                @else--}}
                                        {{--                                                    <li><a href="{{ $categoryProducts->previousPageUrl() }}"><i class="lni lni-chevron-left"></i></a></li>--}}
                                        {{--                                                @endif--}}

                                        {{--                                                @foreach ($categoryProducts->getUrlRange(1, $categoryProducts->lastPage()) as $page => $url)--}}
                                        {{--                                                    @if ($page == $categoryProducts->currentPage())--}}
                                        ...
                                        {{--                                                    <li><a href="{{ $categoryProducts->nextPageUrl() }}"><i class="lni lni-chevron-right"></i></a></li>--}}
                                        {{--                                                @else--}}
