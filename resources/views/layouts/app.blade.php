            ...
            <div class="container-fluid main-container">
                <div class="d-flex">
                    ...
                    <a class="logo-horizontal " href="{{route('dashboard')}}">
                        <img src="{{asset('/')}}website/assets/images/logo/logome.png" class="header-brand-img desktop-logo" alt="logo">
                        <img src="{{asset('/')}}website/assets/images/logo/logome.png" class="header-brand-img light-logo1"
                             alt="logo">
                    </a>
                    <!-- LOGO -->
            ...
            <div class="app-sidebar">
                <div class="side-header">
                    <a class="header-brand1" href="{{route('dashboard')}}">
                        <img src="{{asset('/')}}website/assets/images/logo/logome.png" class="header-brand-img desktop-logo" alt="logo">
                        <img src="{{asset('/')}}website/assets/images/logo/logome.png" class="header-brand-img toggle-logo" alt="logo">
                        <img src="{{asset('/')}}website/assets/images/logo/logome.png" class="header-brand-img light-logo" alt="logo">
                        <img src="{{asset('/')}}website/assets/images/logo/logome.png" class="header-brand-img light-logo1" alt="logo">
                    </a><!-- LOGO -->
                </div>
                    ...
                    <ul class="side-menu">
                        ...
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <span class="side-menu__label">Slider Module</span>
                                <i class="angle fa fa-angle-right"></i>
                            </a>
                            <ul class="slide-menu">
                                <li><a href="{{route('slider.add')}}" class="slide-item">Add Slider</a></li>
                                <li><a href="{{route('slider.manage')}}" class="slide-item">Manage Sliders</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                ...
                                <li><a href="{{route('brand.add')}}" class="slide-item"> Add Brands</a></li>
                                <li><a href="{{route('brand.manage')}}" class="slide-item">Manage Brands</a></li>
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                ...
                                <li><a href="{{route('unit.manage')}}" class="slide-item">Manage Units</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a href="{{route('courier.add')}}" class="slide-item">Add Courier</a></li>
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                ...
                                <li><a href="{{route('admin-order.all')}}" class="slide-item">Orders</a></li>
